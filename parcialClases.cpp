...
int main() {
  ...
  cout << "--------------------------------" << endl;
  cout << endl;
  cout << "Constructor objeto sin argumentos:" << endl;
  Derivada d1;
  cout << endl;
  cout << "Constructor objeto con un argumento:" << endl;
  Derivada d2(1);
  cout << endl;
  cout << "Constructor objeto con dos argumentos:" << endl;
  Derivada d3(1, 2);
  cout << endl;
  cout << "Constructor objeto con tres argumentos:" << endl;
  Derivada d4(1, 2, 3);
  cout << endl;
  cout << "Constructor objeto con cuatro argumentos:" << endl;
  Derivada d5(3, 2, 5, 8);  
  cout << endl;
  cout << "--------------------------------" << endl;
